...
try {
 ...
 /*  Ana Sayfa İçin Kullanılan Fonksiyonlar */
    ...
    function showContent($db, $id){
        $pages = $db->query("SELECT * FROM blog_content where category_id = $id and blog_content.visibility=1 ORDER BY category_id DESC ", PDO::FETCH_OBJ)->fetchAll();
        return $pages;
    }
/*  ...................................... */
