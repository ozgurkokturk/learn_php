            ...
            <div class="col-lg-10 mb-5 addTextMotherDiv">
                ...
                <form action="usage_database/add_new_content.php" id="addNewContent" method="post">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                            <input type="text" name="titleContent" class="form-control" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <textarea class="form-control" name="textareaContent" id="textareaContent"></textarea>
                            <script>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="labelsContent" class="form-control" placeholder="Virgül ile kelimeleri ayırın!" required>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-3">
                            <input type="date" name="dateContent" class="form-control" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <div class="form-check form-check-inline">
                              <input type="radio" class="form-check-input" name="radioContent" id="gridRadios1" value="1" checked>
